...
This is why we've built the trending open source **[MindStack](https://github.com/assafelovic/gpt-researcher)**. MindStack is an autonomous agent that takes care of the tedious task of research for you, by scraping, filtering and aggregating over 20+ web sources per a single research task. 
